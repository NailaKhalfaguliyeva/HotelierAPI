...
namespace Hotelier.Api.DataAccessLayer.Migrations
{
    ...
    [Migration("20260117185413_latest_migration_update")]
    partial class latest_migration_update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotelier.Api.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("Hotelier.Api.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Hotelier.Api.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
